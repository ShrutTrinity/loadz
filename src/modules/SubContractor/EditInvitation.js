...
import styles from './Styles/editInvitation.module.scss'
...
const EditInvitation = ({openEditInvitation, closeEditInvitation}) => {
  ...
  return (
    <Dialog
      open={openEditInvitation}
      onClose={closeEditInvitation}
