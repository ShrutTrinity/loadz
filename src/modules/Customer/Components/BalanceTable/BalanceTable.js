  ...
  return (
    ...
    <Table  aria-label="simple table">
      <TableHead sx={{backgroundColor:'#e7cc0b',fontWeight:800}}>
        <TableRow>
          <TableCell sx={{fontWeight:800,fontSize:'16px'}}>Customer</TableCell>
          <TableCell sx={{fontWeight:800,fontSize:'16px'}} >Current</TableCell>
      ...
      <TableBody sx={{backgroundColor:'#222'}}>
        {rows.map((row) => (
          ...
          >
            <TableCell sx={{fontWeight:800,fontSize:'16px',color:'white'}}component="th" scope="row">
              {row.name}
            </TableCell>
