                        ...
                        <form className={styles.Createform}>
                            ...
                            <div className={styles.inputControl2}>
                                ...
                                <div className={styles.input2}>
                                    <input type={showPassword ? 'tel' : 'password'} className="form-control rounded-0" id="exampleFormControlInput1" placeholder="Enter your Phone"></input>
                                </div>
                            ...
                            <div className={styles.inputControl2}>
                                <div className={styles.input2}>
                                    <input type={showPassword ? 'text' : 'password'} className="form-control rounded-0" id="exampleFormControlInput1" placeholder="Password"></input>
                                </div>
                                <div className={styles.passIcon} onClick={togglePasswordVisibility}>
                                    {showPassword ? <VisibilityIcon /> : <VisibilityOffIcon />}
                                </div>
                            ...
                            <div className={styles.inputControl3}>
                                <div className={styles.input2}>
                                    <input type={showPassword ? 'text' : 'password'} className="form-control rounded-0" id="exampleFormControlInput1" placeholder="Confirm Password"></input>
                                </div>
                                <div className={styles.passIcon} onClick={togglePasswordVisibility}>
                                    {showPassword ? <VisibilityIcon /> : <VisibilityOffIcon />}
                                </div>
                            ...
                            <label>
                                <div className={styles.inlineContainer}>
                                    ...
                                    <p>I have read and agree to the <RouterLink to='/privacy'>Privacy Policy</RouterLink> and <RouterLink to='/privacy'>term of use</RouterLink>  and  <RouterLink to='/terms'>terms and conditions</RouterLink>.</p>
                                </div>
                                Check the checkbox if you agree with the terms of use, privacy policy and terms and conditions.
                            </label>
                            <Button variant="contained" sx={{ backgroundColor: "rgb(237, 202, 51)", borderRadius: "1.125rem", width: "100%", color: "black", padding: "1.2", marginTop: "10px", marginBottom: "0.5rem", fontSize: '0.813rem', textTransform: 'capitalize', ":hover": { backgroundColor: "rgb(237,202,51)" } }}>
                                Send OTP
                            </Button>
                        </form>
                    </div>
