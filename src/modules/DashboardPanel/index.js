  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route exact path='/truck/all' element={<AddTruckAndTrailer handleDrawerClose={handleDrawerClose} textSelectorOpen={textSelectorOpen} toggleTextSelector={toggleTextSelector} open={open} />} />
      </Routes>
      <Index />
    </>
  );
