...
import styles from './styles/OwnerOperatorDrawer.module.scss';
...
const OwnerOperatorDrawer = ({ openResponsiveDrawer, closeResponsiveDrawer, height, width }) => {
  ...
  const openownerOperatorDetailScreen = () => {
    setOwnerOperatorDetailScreen(!ownerOperatorDetailscreen)
  };
